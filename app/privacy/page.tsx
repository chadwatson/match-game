...
function P(props: HTMLProps<HTMLParagraphElement>) {
  return <p {...props} className="mt-2 mb-4" />;
}

function H2(props: HTMLProps<HTMLParagraphElement>) {
  return <h2 {...props} className="text-xl font-bold mt-8 mb-2" />;
}

function H3(props: HTMLProps<HTMLParagraphElement>) {
  return <h3 {...props} className="text-lg font-bold mt-6 mb-2" />;
}

function H4(props: HTMLProps<HTMLParagraphElement>) {
  return <h4 {...props} className="text font-bold mt-6 mb-2" />;
}

function Ul(props: HTMLProps<HTMLUListElement>) {
  return <ul {...props} className="mb-4 pl-8 list-disc" />;
}
...
export default function PrivacyPage() {
  return (
    <div className="max-w-3xl mx-auto">
      ...
      <Ul>
        ...
        <li>
          <P>
            ...
            this Agreement) refers to Match &amp; Match.
          </P>
        </li>
        <li>
          <P>
        ...
        <li>
          <P>
            <strong>Website</strong> refers to Match &amp; Match, accessible
            from{" "}
            <a
              href="https://matchmatch.app"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://matchmatch.app
            </a>
          </P>
        </li>
        <li>
      ...
      <Ul>
        <li>By email: chadwatsn@gmail.com</li>
      </Ul>
    </div>
  );
}
